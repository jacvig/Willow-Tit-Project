...
Previous research, including the national survey, also used citizen-science data collected by volunteers and submitted through recording systems such as [Birdtrack](https://www.bto.org/our-science/projects/birdtrack). These raw data are held by the [BTO](bto.org) and must be [requested](https://www.bto.org/data). Although this is not a preventative barrier, it is nontheless restrictive. Since the eBird dataset is freely available, anyone can access it and contribute to the research.
...
As of December 3, 2024, the BTO released a publicly available dataset from their Breeding Bird Survey [@british_trust_for_ornithology_2024_14161736]. These data cover a thirty-year period (1994-2023) and contain the data collected during the [Breeding Bird Survey (BBS)](https://www.bto.org/our-science/projects/breeding-bird-survey) in the United Kingdom. BBS data are collected twice a year during the breeding season for all species that breed in the UK.
