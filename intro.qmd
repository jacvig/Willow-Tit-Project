...
Raw data from the survey were not made publicly availalbe, but it was [reported by the RSPB](https://community.rspb.org.uk/ourwork/b/science/posts/results-from-the-national-willow-tit-survey) that Willow Tit populations were highest in the following counties:
...
Previous research, including the national survey, also used citizen-science data collected by volunteers and submitted through recoding systems such as [Birdtrack](https://www.bto.org/our-science/projects/birdtrack). However, these data are not publically available and are held behind a paywall by the [BTO](bto.org). Therefore, opportunities to make use of this data are limited. Since eBird is a freely available dataset, this makes it a unique and vaulable source of data on Willow Tits.
