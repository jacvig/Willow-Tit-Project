...
It is clear that the two datasets give a similar picture with populations of Willow Tits occurring in the north east, north west, midlands, and areas of Wales. More than anything, this may demonstrate the value of eBird as a data source.

## Willow Tits in the North West

According the the Lancashire Wildlife Trust, more than 15% of the UK's Willow Tits are found in the North West. Over the past few years, the Trust has been running their [Wet Willow Wildlife](https://www.lancswt.org.uk/wet-willow-wildlife) project aimed at improving habitats across Greater Manchester and the surrounding areas. The project is currently ongoing and the data are not publically available. I thought it would be interesting to plot both the BTO and eBird data on the area surrounding Manchester to see the results. Note, I used all the BBS data available as there were fewer data points.
...
Again, this was an interesting exercise. The eBird data added to the picture already in place, but it also revealed that many of the observations occur on rivers and water features where habitat is idea for Willow Tits. The picture also shows that these waterways may function as corridors allowing Willow Tits to move and establish new territories.
